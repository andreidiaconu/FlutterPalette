...
class PaletteLib {
  ...
  static Future<dynamic> getPalette(String path) async {
    Map<dynamic, dynamic> result = await _channel.invokeMethod('getPalette', {'path' : path});
    return Palette.fromJson(result);
  }
}

class Palette{
  final PaletteSwatch vibrant, darkVibrant, lightVibrant, muted, darkMuted, lightMuted;
  final List<PaletteSwatch> swatches;

  Palette.fromJson(Map<dynamic, dynamic> map):
        vibrant = map['vibrant'] == null ? null : new PaletteSwatch.fromJson(map['vibrant']),
        darkVibrant = map['darkVibrant'] == null ? null : new PaletteSwatch.fromJson(map['darkVibrant']),
        lightVibrant = map['lightVibrant'] == null ? null : new PaletteSwatch.fromJson(map['lightVibrant']),
        muted = map['muted'] == null ? null : new PaletteSwatch.fromJson(map['muted']),
        darkMuted = map['darkMuted'] == null ? null : new PaletteSwatch.fromJson(map['darkMuted']),
        lightMuted = map['lightMuted'] == null ? null : new PaletteSwatch.fromJson(map['lightMuted']),
        swatches = map['swatches'] == null
            ? null
            : (map['swatches'] as List<dynamic>)
            .map((json)=>new PaletteSwatch.fromJson(json)).toList(growable: false);
  ...
  Map<String, dynamic> toJson() => {
    ...
    "swatches": swatches == null ? null : swatches.map((swatch)=>swatch.toJson()).toList(growable: false),
  };
...
class PaletteSwatch{
  ...
  const PaletteSwatch({this.color, this.titleTextColor, this.bodyTextColor, this.population});

  PaletteSwatch.fromJson(Map<dynamic, dynamic> map):
        color = map['color']==null ? null : new Color(map['color']),
        titleTextColor = map['titleTextColor']==null ? null : new Color(map['titleTextColor']),
        bodyTextColor = map['bodyTextColor']==null ? null : new Color(map['bodyTextColor']),
